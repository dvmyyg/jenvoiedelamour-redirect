...
// ✅ **Utilise ContactsCarousel pour afficher les destinataires avec un effet visuel de carrousel vertical avec bouclage infini.** // <-- NOUVEAU
...
// -------------------------------------------------------------
// V012 - Intégration du widget ContactsCarousel pour l'affichage des destinataires (remplace PageView.builder). - 2025/06/06 21h50 // <-- NOUVELLE ENTRÉE
...
// GEM - code corrigé par Gémini le 2025/06/06 // Mise à jour le 06/06 // 🎯 DATE MISE À JOUR ICI
...
import 'package:jelamvp01/widgets/contacts_carousel.dart'; // Ajout carroussel page d'accueil
        ...
        Expanded( // Le StreamBuilder prend l'espace restant
          child: StreamBuilder<List<Recipient>>(
            ...
            builder: (context, snapshot) {
              ...
              // 🎯 DÉBUT DU NOUVEAU BLOC (Remplacement du PageView.builder)

              // 1. Générer la liste de widgets (cartes) pour le carrousel
              final List<Widget> recipientCards = recipients.map((r) {
                // C'est la structure de la carte que tu utilisais dans le PageView.builder
                // On l'enveloppe dans un Center pour un bon alignement dans le carrousel
                return Center( // Centre chaque élément dans le carrousel
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      height: 140, // Hauteur fixe - CORRESPOND À L'ITEM EXTENT DU CARROUSEL
              ...
              // 2. Afficher la liste des cartes via le ContactsCarousel
              // On passe la liste de widgets générée et la hauteur de chaque carte.
              return ContactsCarousel(
                cards: recipientCards,
                itemExtent: 140, // 🎯 Utilise la hauteur définie pour tes cartes
              );
