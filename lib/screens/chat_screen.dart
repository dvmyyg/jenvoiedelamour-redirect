...
// -------------------------------------------------------------
// ✅ Écran d'interface utilisateur pour les conversations de chat.
// ✅ Affiche les messages en temps réel via un Stream de messages.
// ✅ Permet l'envoi de messages rapides prédéfinis.
// ✅ Utilise les UID Firebase de l'utilisateur actuel et du destinataire pour gérer la conversation.
// ✅ S'appuie sur les modèles Message et Recipient refactorisés et le MessageService.
// -------------------------------------------------------------
// 🕓 HISTORIQUE DES MODIFICATIONS
// -------------------------------------------------------------
// V004 - Correction de l'appel à Message.quick() pour inclure le paramètre 'content'. - 2025/05/30
            ...
            child: Center(
              child: ElevatedButton.icon(
                onPressed: () async {
                  ...
                  final msg = Message.quick(from: currentUserId, to: recipientUserId, content: "❤️");
