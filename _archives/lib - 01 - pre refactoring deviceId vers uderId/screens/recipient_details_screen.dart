...
// V007 - Amélioration UI bulles de messages (taille, couleur, padding, arrondi) - 2025/05/29 17h43
                    ...
                    return Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(10), // réduit de 20%
                        ),
                        child: Column(
                          ...
                          children: [
                            Text(
                              msg.content,
                              style: const TextStyle(color: Colors.white, fontSize: 18), // +25%
                            ),
                            const SizedBox(height: 2), // réduit
                            Text(
                              DateFormat.Hm().format(msg.sentAt.toDate()),
                              style: const TextStyle(color: Colors.white60, fontSize: 10), // plus lisible
                            ),
                          ],
                        ),
                      ),
