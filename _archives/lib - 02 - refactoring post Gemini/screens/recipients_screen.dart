...
// V007 - ajout vérification doublon lors de l'appairage manuel - 2025/05/26 09h38 (Historique hérité)
...
// On a besoin de cloud_firestore pour l'appairage manuel (_showPasteLinkDialog)
import 'package:cloud_firestore/cloud_firestore.dart';
// Firebase Auth pour obtenir l'UID de l'utilisateur actuel
import 'package:firebase_auth/firebase_auth.dart';
// On importe la fonction d'appairage (_pairUsers) définie dans main.dart
import '../main.dart' show _pairUsers; // Importe spécifiquement _pairUsers depuis main.dart
          ...
          TextButton(
            onPressed: () async {
              ...
              if (recipientInviterUid != null && recipientInviterUid.isNotEmpty && _currentUserId != recipientInviterUid) {
                ...
                final String? pairedWithUid = await _pairUsers(recipientInviterUid, _currentUserId!);
