...
// La logique du bouton appelle la méthode _register refactorisée.
    ...
    obscureText: true, // Masque le texte
      ...
      TextButton(
        onPressed: _isLoading ? null : () { // Désactivé pendant l'inscription pour éviter les actions multiples
        ...
        style: TextButton.styleFrom(foregroundColor: Colors.white70), // Couleur du texte
      ),
